...
class AdvExoplayerActivity : AppCompatActivity(), Player.EventListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_adv_exo_player)
    ...
    fun getMediaItem() : MediaItem {
        ...
        return MediaItem.Builder()
            .setUri(Uri.parse("https://media.chingari.io/apipublic/uploads/postMedia/863fc92f-20e8-4a5e-9fc6-856bdfd60c8d-1610723727970.mp4"))
